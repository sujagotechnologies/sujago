...
const sectionId = (id: (typeof NAV_ITEMS)[number]["id"]) => id;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <InfoPill icon={MapPin} label={HERO.location} />
        ...
        >
          <Button asChild size="lg" className="group">
            <Link href={`#${sectionId("contact")}`}>
              Get in touch
              <Mail className="ml-2 size-4 transition-transform group-hover:translate-x-1" />
            </Link>
          </Button>
          {primarySocial ? (
          ...
          <Button
            ...
            className="group"
            onClick={() => {
              window.location.href = "/assets/Jayant.pdf";
            }}
          >
            Download CV
      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-[1.4fr,1fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              A quick snapshot of who I am and how to reach me.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-0">
            <h4 className="mb-2 text-sm font-semibold">Connect with me</h4>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg">
                  <set.icon className="size-5 text-primary" />
                  {set.title}
                </CardTitle>
              </CardHeader>
...
function ContactItem({
  ...
  const content = (
    <div className="flex items-center gap-3 rounded-lg border bg-background px-3 py-2 transition hover:-translate-y-0.5 hover:shadow-sm">
